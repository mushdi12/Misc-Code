...
public class Buttery2 {
    private final MyTelegramBot bot;

    public Buttery2(MyTelegramBot bot) {
        this.bot = bot;
    }

    public void sendPaysB2Menu(long chatId,String username) {
        SendMessage message = new SendMessage();
        message.setChatId(chatId);
        message.setText("Оплатите по ссылке снизу\nhttps://t.me/tribute/app?startapp=d6XJ\nУкажите тг никнейм -> " + username+ " в комментариях для автора");
        ...
        button1.setCallbackData("finish_but_2");
        row1.add(button1);
        keyboard.add(row1);
